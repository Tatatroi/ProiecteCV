...
<body>
    ...
    <div id="info">
        <img src="imagini/masiniglob.png" alt="logo">
        <div id="titlu">Cine suntem si cu ce ne ocupam?</div>
        <div id="desprenoi"><p>Echipa masini de vis te ajuta sa iti gasesti autovehiculul care ti se potriveste<br> 
            la perfectie. Fie ca ai nevoie de o masina de familie, de lux sau una mica de oras noi suntem<br>
            aici ca sa te ajutam. Suntem conectati la piata nationala si internationala, iar tot ce trebuie sa<br>
            faci ca si utilizatior este sa ne contactezi, iar noi iti vom trimite pe mail sau pe WhatsApp 
            masina de care ai nevoie.<br> <div id="nu">Nu ezita, masina de vis nu va avea niciodata mai putini kilometri!</div> </p>
        </div>
    </div>
